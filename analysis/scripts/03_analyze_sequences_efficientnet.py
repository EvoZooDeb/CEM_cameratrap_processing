...
# Group models
#model_path_c = "/path/to/carnivora/model/temp/2_wolf_camtrap_carnivora_EfficientNetV2L_unfrozen_best_lr00001.keras" # Carnivora
                    ...
                    with open(path + frame) as f:
                        for line in f.readlines():
                            ...
                            if float(label) != 1 and float(label) != 2:
                                ...
                                # TOP3
                                classification_results = np.argpartition(classification_results[0], -3)[-3:] # TOP3
...
prediction_results  = analyze_sequence(prediction_path, result_path + "EfficientNet_seq_class_TOP3_predicted_results.csv")
