...
ground_truth_path = "/directory/containing/groundtruth/results/ss_seq_ground_truth_results.csv"
prediction_path   = "/directory/containing/detection/results/DeepFaune_seq_class_TOP3_predicted_results.csv"
